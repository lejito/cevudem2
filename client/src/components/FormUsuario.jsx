...
function FormUsuario() {
    ...
    const { notif, buscarUsuarios, buscarUsuario, insertarUsuario, actualizarUsuario } = useAppContext()
            ...
            <Formik
                ...
                onSubmit={async (values) => {
                    if (params.documento) {
                        ...
                        if (respuesta.error) {
                            notif("error", "Hubo un error al intentar editar el usuario", 4001)
                        }
                        else {
                            notif("success", "Usuario editado correctamente.", 4002)
                        }
                    }
                    else {
                        ...
                        if (respuesta.error) {
                            ...
                            notif("success", "Usuario añadido correctamente.", 4004)
                        }
                    }
